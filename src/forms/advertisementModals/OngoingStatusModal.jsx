// // components/modals/OngoingStatusModal.jsx
// import BaseModal from "./BaseModal";

// export default function OngoingStatusModal({ open, onClose, status }) {
//   return (
//     <BaseModal open={open} onClose={onClose}>
//       <div className="p-6 text-center">
//         <h2 className="text-xl font-semibold mb-3">⏳ Ongoing Status</h2>
//         <p className="text-gray-700 mb-4">
//           {status || "Your test is currently in progress..."}
//         </p>
//         <button
//           onClick={onClose}
